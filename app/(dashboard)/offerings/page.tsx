...
export default function OfferingsPage() {
  ...
  const typeLabels = useMemo(
    () => ({
      ...
      HOMESTAY: t('offering.types.homestay'),
      VILLA: t('offering.types.villa'),
      CHAUFFEUR: t('offering.types.chauffeur'),
      AIRPORT_PICKUP: t('offering.types.airportPickup'),
      FULL_TANK: t('offering.types.fullTank'),
      TOLL_PASS: t('offering.types.tollPass'),
